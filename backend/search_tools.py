...
class CourseOutlineTool(Tool):
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get the complete lesson outline for a course including course title, course link, and all lessons with their numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        # Track source for UI
        self.last_sources = [{"title": outline["title"], "url": outline.get("course_link")}]

        # Format output
        result = f"Course: {outline['title']}\n"
        result += f"Course Link: {outline.get('course_link', 'N/A')}\n\n"
        result += "Lessons:\n"
